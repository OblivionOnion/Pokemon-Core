...
class Pagination {
	...
	function echoPagination() {
		...
		// if (!$this->onFirstPage()) {
			// echo '<li'.$this->firstPageClass().'><a href="'.$this->queryString.'&amp;page=1">First</a></li>';
		// }
		
		echo '<li><a href="'.$this->queryString.'&amp;page=1">First</a></li>';
		...
		echo '<li><a href="'.$this->queryString.'&amp;page='.$this->numPages.'">Last</a></li>';
		
		// if (!$this->onLastPage()) {
			// echo '<li'.$this->lastPageClass().'><a href="'.$this->queryString.'&amp;page='.$this->numPages.'">Last</a></li>';
		// }
